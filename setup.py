...
setuptools.setup(
    ...
    packages=['keboola.json_to_csv',
              'keboola.json_to_csv.analyzer',
              'keboola.json_to_csv.csv_row',
              'keboola.json_to_csv.exception',
              'keboola.json_to_csv.mapping',
              'keboola.json_to_csv.node',
              'keboola.json_to_csv.parser',
              'keboola.json_to_csv.table',
              'keboola.json_to_csv.utils'],
    package_dir={'': 'src'},
